...
export function FeishuIntegrationCard({
  ...
  return (
    <>
      ...
      {open && (
        <ModalPortal>
          <div className="fixed inset-0 z-[200] flex items-center justify-center overflow-y-auto bg-pixel-black/45 px-4 py-6">
          <div
          ...
          >
            <div className="shrink-0 border-b-4 border-pixel-black px-5 py-4">
            ...
            <div className="flex shrink-0 items-center justify-between gap-3 border-t-4 border-pixel-black bg-pixel-black/5 px-5 py-4">
              <a
                href={FEISHU_DOC_URL}
                target="_blank"
                rel="noreferrer"
